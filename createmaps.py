...
sumofsm.write_csv("keggNorm.csv")
...
sumofsm.columns = pd.MultiIndex.from_frame(
        gut_formatted_names[[0,2,'Type']],
        names=['Patient','Days after treatment', 'Type'])
sumofsm.write_csv("antismashNorm.csv")
...
sumofsm.columns = pd.MultiIndex.from_frame(
        gut_formatted_names[[0,2,'Type']],
        names=['Patient','Days after treatment', 'Type'])
sumofsm.write_csv("pfamNorm.csv")
...
sumofsm.columns = pd.MultiIndex.from_frame(
        gut_formatted_names[[0,2,'Type']],
        names=['Patient','Days after treatment', 'Type'])
sumofsm.write_csv("patricNorm.csv")
...
sumofsm.columns = pd.MultiIndex.from_frame(
        gut_formatted_names[[0,2,'Type']],
        names=['Patient','Days after treatment', 'Type'])
sumofsm.write_csv("cardNorm.csv")
