...
sns.pointplot(data=meta_joined.loc[(meta_joined.Site == 'Gut') & (meta_joined.Type == 'FMT')], x=x, y=y, hue='id', legend=False, scale=0.4, palette=['C1'], joined=True, ax=gut_patient_ax, kwargs={"alpha":0.5})
