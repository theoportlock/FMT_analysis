...
sns.boxplot(ltdf, x='Days after treatment', y= 'gut Veillonella', hue='Type')
ltdf['gut Veillonella']
sns.boxplot(ltdf, x='Days after treatment', y= 'gut Veilonella', hue='Type')
ltdf['gut Veillonella']
ltdf['gut Veillonella'].values()
ltdf['gut Veillonella'].values
ltdf['gut Veillonella'].values
sns.boxplot(data=ltdf, x='Days after treatment', y= 'gut Veilonella', hue='Type')
sns.boxplot(data=ltdf, x='Days after treatment', y= 'gut Veillonella', hue='Type')
plt.show()
sns.boxplot(data=ltdf, x='Days after treatment', y= 'gut Veillonella', hue='Type')
sns.boxplot(data=ltdf, x='Days after treatment', y= 'gut Veillonella', hue='Type')
plt.show()
sns.swarmplot(data=ltdf, x='Days after treatment', y= 'gut Veillonella', hue='Type')
plt.show()
sns.swarmplot(data=ltdf, x='Days after treatment', y= 'gut Streptococcus', hue='Type')
plt.show()
'''
