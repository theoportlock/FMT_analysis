...
#theoeditstart
significant_matrix = pd.DataFrame(significant_matrix, columns=correlations.columns, index=correlations.index)
significant_matrix = significant_matrix.loc[significant_matrix.columns.str.contains('msp'),~significant_matrix.columns.str.contains('msp')]
correlations = correlations.loc[correlations.columns.str.contains('msp'),~correlations.columns.str.contains('msp')]
