...
oralplacatt1
oralplacatt1.reset_index()
oralplacatt1.reset_index().groupby('phylum')
oralplacatt1.reset_index().groupby('phylum').sum()
tmp = pd.DataFrame()
tmp1 = oralplacatt1.reset_index().groupby('phylum').sum()
tmp['F/B'] = tmp1.loc[:,'Firmicutes'].div(tmp1.loc[:,'Bacteroidetes'])
oralplacatt1.reset_index().groupby('phylum').sum()
tmp['F/B'] = tmp1.loc['Firmicutes',:].div(tmp1.loc['Bacteroidetes',:])
tmp
tmpplot = tmp.reset_index()
tmpplot
sns.boxplot(tmpplot, x='Day',y='F/B',hue='Type')
sns.boxplot(data = tmpplot, x='Day',y='F/B',hue='Type')
plt.show()
sns.lineplot(data = tmpplot, x='Day',y='F/B',hue='Type')
plt.show()
sns.boxplot(data = tmpplot, x='Day',y='F/B',hue='Type')
sns.swarmplot(data = tmpplot, x='Day',y='F/B',hue='Type')
plt.show()
get_ipython().run_line_magic('history', '')
fig, (gut_donor_ax, gut_patient_fmt_ax, gut_patient_placebo_ax, oral_patient_fmt_ax, oral_patient_placebo_ax) = plt.subplots(1, 5, sharey=True, gridspec_kw={'width_ratios': [1, 4, 4, 4, 4]})
tmp1 = gutfmtatt1.reset_index().groupby('phylum').sum()
tmp['F/B'] = tmp1.loc['Firmicutes',:].div(tmp1.loc['Bacteroidetes',:])
tmpplot = tmp.reset_index()
sns.boxplot(data = tmpplot, x='Day',y='F/B',hue='Type',ax='gut_patient_fmt_ax')
sns.swarmplot(data = tmpplot, x='Day',y='F/B',hue='Type')
tmp1 = gutfmtatt1.reset_index().groupby('phylum').sum()
tmp1
gutfmtatt1
...
sns.boxplot(data = tmpplot, x='Day',y='F/B',hue='Type')
plt.show()
fig, (donor_ax, gut_ax, oral_ax) = plt.subplots(1, 3, sharey=True, gridspec_kw={'width_ratios': [1, 4, 4]})
tmp1 = gutfmtatt1.reset_index().groupby('phylum').sum()
tmp['F/B'] = tmp1.loc['Firmicutes',:].div(tmp1.loc['Bacteroidetes',:])
tmpplot = tmp.reset_index()
#sns.boxplot(data = tmpplot, x='Day',y='F/B',hue='Type',ax='gut_patient_fmt_ax')
...
sns.swarmplot(data = tmpplot, x='Day',y='F/B',hue='Type')
plt.show()
donorfmtatt1 = taxa_not_sum.xs('Donor',level=0,axis='columns')
donorfmtatt1
tmp1 = gutfmtatt1.reset_index().groupby('phylum').sum()
tmp1 = donorfmtatt1.reset_index().groupby('phylum').sum()
donorfmtatt1 = taxa_not_sum.xs('Donor',level=0,axis='columns')
donorfmtatt1
donorfmtatt1.reset_index()
donorfmtatt1.reset_index().groupby('phylum')
donorfmtatt1.reset_index()
donorfmtatt1 = taxa_not_sum.xs('Donor',level=0,axis='columns').reset_index()
donorfmtatt1.columns = donorfmtatt1.columns.to_flat_index()
get_ipython().run_line_magic('history', '')
tmp1 = donorfmtatt1.reset_index().groupby('phylum').sum()
tmp1
donorfmtatt1.reset_index(inplace=True)
donorfmtatt1
donorfmtatt1 = taxa_not_sum.xs('Donor',level=0,axis='columns')
donorfmtatt1
donorfmtatt1.columns = donorfmtatt1.columns.to_flat_index()
...
donorfmtatt1.reset_index(inplace=True)
donorfmtatt1
tmp1 = donorfmtatt1.groupby('phylum').sum()
tmp['F/B'] = tmp1.loc['Firmicutes',:].div(tmp1.loc['Bacteroidetes',:])
tmp
tmp1
tmp=pd.DataFrame()
...
tmp
tmpplot = tmp.reset_index()
get_ipython().run_line_magic('save', 'back.py 1-144')
